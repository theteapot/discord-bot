module.exports = function main() {
    ...
    http.get('http://localhost:8888/code', (res) => {
        ...
        res.on('end', () => {
            try {
                ...
                console.log('Picking active playlist:');
                playlistPicker(parsedData.id);
                console.log('Starting playing tracker');
    ...
    */ 
    ...
    function getNextPos(callback) {
        var playlistPromise = rp('http://localhost:9999/playlist/6ekP7XeoMqvAeOu4ZRxbIq/whistlingteapot').then(function (playlist) {
    ...
    function addTrack (uri, next) {
        if (next) {
            getNextPos(function(nextPos) {
                ...
                spotifyApi.addTracksToPlaylist('whistlingteapot', '6ekP7XeoMqvAeOu4ZRxbIq', uri, {position: nextPos}).then(function(data) {
